...
router.post("/",jwtAuth,productController.productAdd);

router.put("/:id",jwtAuth,productController.productUpdate);

router.delete("/:id",jwtAuth,productController.productRemove);

router.get("/list",productController.productList);

router.get("/list/:id",productController.productId);

router.post("/cart/:id",jwtAuth,productController.cartAdd);
...
// router.post("/cart/:id",jwtAuth,async(req,res)=>{
//     try{
//         const id=req.params.id;
...
// router.post("/buy/:id",jwtAuth,async(req,res)=>{
//     try{
//         const id=req.params.id;
//         const prod=await Product.findById(id);
//         if (!prod) {
...
//             status: "PLACED"
//         });
//         res.status(200).json({message: 'Order successfully',orderId: order._id});
//     }catch(err){
//         console.log(err);
//         res.status(500).json({error: 'Internal Server Error'});
//     }
