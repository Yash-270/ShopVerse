...
router.delete("/:id",jwtAuth,cartController.cartRemove);

router.get("/mycart",jwtAuth,cartController.myCart);

router.put("/:id",jwtAuth,cartController.cartUpdate);
...
// router.get("/mycart",jwtAuth,async(req,res)=>{
//     try{
//         if (req.user.role !== "Customer") {
//             return res.status(403).json({ error: "Not allowed" });
//         }
